...
let allKeys = [];
let audio = new Audio("https://mohusam.github.io/Piano_game/tunes/a.wav"); // by default, audio src is "a" tune
let playtune = (key) => {
  audio.src = `https://mohusam.github.io/Piano_game/tunes/${key}.wav`;
